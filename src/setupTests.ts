...
vi.mock("@api-playground/core/constants/appConfig", () => ({
	default: {
		API_KEYS: {
...
vi.mock("react-map-gl/maplibre", () => ({
	Marker: vi.fn().mockImplementation(() => null),
	Source: vi.fn().mockImplementation(() => null),
	Layer: vi.fn().mockImplementation(() => null),
	LngLat: {},
	MapRef: {},
	useMap: () => ({ current: {} }),
	useControl: vi.fn()
