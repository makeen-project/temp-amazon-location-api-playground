...
function main() {
	try {
		// Cleaning up existing api-playground-app-lib directory...
		console.log("Cleaning up existing api-playground-app-lib directory...");
		...
		// Modifying package.json for api-playground-app-lib...
		console.log("Modifying package.json for api-playground-app-lib...");
		...
		console.log("Created api-playground-app-lib prepared successfully.");
	} catch (error) {
